...
# #bladejs fix
	# 1. Исправлено пропадание админ-авто при нахождении в воде\
	# 2. Убрана команда /key Теперь можно запускать Т.С без ключа, было убрано из-за того, что просто мешало.\
	# 3. Фикс работы (оружейный завод), добавлен новый тд информации.\
	# 4. Доступ к управлению штата для Президента дается с помошью вписания его Ника в игровой мод.\
	# 5. Изменен ТД информации на работе (Нефтезавод)\
	# 6. Изменены цвета некоторых пикапов, чтобы было глазу приятно их увидеть.\
	# 7. Добавлеы мап-иконки на карте\
	# 8. Изменен полет камеры при авторизации.....
